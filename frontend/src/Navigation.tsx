					...
					{recentAgents?.length > 0 ? (
						<div>
							...
							<div className="agents-container">
								<div>
									{recentAgents.map((agent, idx) => (
										<button
											...
											className={`group mx-4 my-auto mt-4 flex h-9 w-full cursor-pointer items-center justify-between rounded-3xl border-0 bg-transparent pl-4 text-left hover:bg-bright-gray dark:hover:bg-dark-charcoal ${
								...
								<button
									type="button"
									className="mx-4 my-auto mt-2 flex h-9 w-full cursor-pointer items-center gap-2 rounded-3xl border-0 bg-transparent pl-4 text-left hover:bg-bright-gray dark:hover:bg-dark-charcoal"
									onClick={() => {
										dispatch(setSelectedAgent(null));
										if (isMobile || isTablet) {
											setNavOpen(false);
					...
					<div className="flex flex-col justify-end text-eerie-black dark:text-white">
						<div className="flex items-center justify-between py-1">
							...
							<div className="flex items-center gap-1 pr-4">
								<NavLink
									target="_blank"
									to={"https://teamonline.aarons.com"}
									className={
